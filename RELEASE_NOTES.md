...
v3.4.0 adds **in-app messaging**: campaigns authored in the Gameball dashboard, displayed inside your app. It is opt-in and additive — an app that upgrades and changes nothing behaves exactly as it did on 3.2.1. No requests, no timers, no overlay and no stored state exist until you call `startInAppMessaging`.
