...
void main() {
  ...
  group('image sizing', () {
    ...
    testWidgets('artwork can never squeeze out the copy and buttons',
        (tester) async {
      // Without this guard the aspect constraint simply wins, which on a
      // cramped screen means a broken constraint rather than a decision.
  ...
  group('layout: header without body', () {
