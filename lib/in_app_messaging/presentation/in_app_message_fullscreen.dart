...
///   the buttons **over** it — the pattern most consumer apps ship: full-bleed
///   promo art with one call to action and the copy baked into the artwork.
///
            ...
            children: [
              if (hasImage)
                SizedBox(
                  ...
                  // artwork — 35 of background either side of a portrait
                  // poster on a 390-wide screen. Half the content height is a
                  // share the artwork can be designed against.
                  height: constraints.maxHeight *
                      FullscreenMetrics.imageHeightFraction,
                  child: Image.network(
                    message.imageUrl!,
                    key: const Key('gb_iam_fullscreen_image'),
                    // Cover, as in the image-only variant. A stacked
                    // fullscreen reads as a poster with copy beneath it rather
                    // than a framed picture, and bars break that reading.
                    fit: BoxFit.cover,
