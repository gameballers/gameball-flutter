...
/// * **No buttons.** The whole surface is the tap target — a banner this size
///   has no room for actions, and a stray tap near a button would be ambiguous.
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              ...
                              // Three lines then ellipsis. A banner that
                              // grows with its copy would eventually cover the
                              // screen it is meant not to block.
                          ...
                          if (message.clickAction != null)
                            Padding(
                              padding: SlideupMetrics.chevronSpacing,
                              child: Icon(
