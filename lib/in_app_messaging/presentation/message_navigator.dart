...
///
/// Holding the key means simply pushing the route. The alternative — handing a
/// URI to the OS and catching the way back in — needs native code and a
/// hand-written channel on the host's side.
