...
/// these, by design: the SDK already logs every event for the messages it
/// displays, so a second call site in app code would double-count. One owner,
/// enforced by the API shape, removes the hazard instead of documenting it.
