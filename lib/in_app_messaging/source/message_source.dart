...
///
/// Used when a sync response omits `cooldownSeconds`. The backend currently
/// sends 30, and the value is server-driven precisely so it can be tuned without
/// a client release.
...
class GameballSyncResult {
  ...
  /// The daily local-time window during which nothing may display, or null when
  /// the account has none. Global, like [cooldown].
